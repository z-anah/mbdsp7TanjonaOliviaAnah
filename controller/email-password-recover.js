                                          ...
                                          <tr>
                                             <td class="mcnTextContent" style='mso-line-height-rule: exactly;
                                                ...
                                                <h1 class="null" style='color: #2a2a2a; font-family: "Asap", Helvetica,
                                                   ...
                                                   padding: 0'><span style="text-transform:uppercase">Mot de passe oublié ?</span></h1>
                                             </td>
                                          </tr>
                                       </tbody>
                                    </table>
                                       ...
                                       <tbody>
                                          <tr>
                                             <td class="mcnTextContent" style='mso-line-height-rule: exactly;
                                                ...
                                                color: #2a2a2a; font-family: "Asap", Helvetica, sans-serif; font-size: 16px;
                                                line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
                                                padding-bottom: 9px; padding-left: 18px;' valign="top">Ne vous inquiétez pas! Nous allons récupérer votre mot de passe.
                                                <br></br>
                                             </td>
                                          </tr>
                                       </tbody>
                                                      ...
                                                      <tr>
                                                         <td align="center" class="mcnButtonContent" style="mso-line-height-rule:
                                                            ...
                                                            <a class="mcnButton " href="pari://" style="mso-line-height-rule: exactly;
                                                               ...
                                                               #FFFFFF; text-transform:uppercase;">RÉINITIALISER</a>
                                                         </td>
                                                      </tr>
                                                   </tbody>
                                                </table>
